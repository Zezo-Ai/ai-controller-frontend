...
class BaseTest extends \PHPUnit\Framework\TestCase
{
	...
	protected function setUp() : void
	{
		...
		$this->stub = $this->createStub( \Aimeos\Controller\Frontend\Catalog\Standard::class );
	...
	public function testFunction()
	{
		...
		$str = $object->function( 'catalog:has', ['domain', 'type', 'refid'] );
	...
	public function testGetTree()
	{
		...
		$this->assertInstanceOf( \Aimeos\MShop\Catalog\Item\Iface::class, $object->getTree() );
	}
